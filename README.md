...
Train an AI agent to play Super Mario Bros using PPO (Proximal Policy Optimization) with customizable reward functions. The branch includes a reward strategy optimized for World 1 completion and obtaining higher scores.
...
### Score Optimized
Gives out more rewards when the agent gets a higher score.
